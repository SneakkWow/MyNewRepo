...
public class EnemyMoveWalking : MonoBehaviour
{
    ...
    bool IsGroundAhead()
    {
        ...
        Vector2 enemyFaceDirection = playerTransform.rotation.y == 0 ? Vector2.left : Vector2.right;

        RaycastHit2D hit = Physics2D.Raycast(playerTransform.position, Vector2.down + enemyFaceDirection, groundCheckDistance, groundLayer);
